...
public class ExchangeStepThreePageController {
    ...
    @GetMapping
    public String getExchangeStepThreePage(@RequestParam String accountFromCode, @RequestParam String accountToCode,
                                           @RequestParam BigDecimal sum, Model model, RedirectAttributes redirectAttributes, HttpServletRequest request) {
