            ...
            <auth:authorize>
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="${adminPage}">${admin.name}</a>
                        <a class="dropdown-item" href="${adminPage}">${admin.email}</a>
