...
public class ExchangeStepTwoPageControllerTest {
    ...
    public void shouldGetExchangeStepTwoPage() {
        String result = testedInstance.getExchangeStepTwoPage(CURRENCY_FROM_CODE, CURRENCY_TO_CODE, model, redirectAttributes);
    ...
    public void shouldGetExchangeStepTwoPageWhenCurrenciesMatches(){
        String result = testedInstance.getExchangeStepTwoPage(CURRENCY_FROM_CODE, CURRENCY_FROM_CODE, model, redirectAttributes);
